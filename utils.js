...
function putBtnHandler(value) {
  ...
  // Make select window for buses
  // Find how to map all the stations
  // Start looking into AI for the approximation of the buses location based on data provided
  // Make it so you can click on each station, see a picture(?) and see a estimated time of arrival(ETA)?
  // Should make a seperate app for the data-collection of bus data.
  document.getElementById("submit").addEventListener("click", function() {
    let selectValue = document.getElementById("bus-select").value
    alert(selectValue);
    // prikazat stanice i lokaciju busa
    // sakrit bus-box
    document.getElementById("bus-box").style.display = "none";
    busHelper(); // funkcija za prikazivanje
    

  });

  document.getElementById("menu-bar").addEventListener("click", function() {
    if(document.getElementById("bus-box").style.display == "block") {
      document.getElementById("bus-box").style.display == "none"
      document.getElementById("menu").style.display = "none";
      location.reload();
    }
